...
const values = [
  ...
  },
  {
    ...
    description: 'הדמעה שרצה, ההבטה הגנובה, הצחוק הפתאומי — אלה הדברים שאני מחפשת.',
  },
  {
    title: 'נוכחות שקטה ביום החתונה',
    description: 'אני שם, אבל לא מורגשת. ככה האורחים מתנהגים טבעי, והרגעים קורים.',
  },
  {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
          ...
          <AnimatedSection className="md:sticky md:top-32">
            ...
            <p className="font-sans text-text-secondary font-light leading-relaxed text-base mt-6">
              אני לא מגיעה לחתונות עם רשימת שוטים. אני מגיעה עם עיניים פתוחות, לב רגיש, וידע עמוק שכל רגע שחולף — לא חוזר.
            </p>
          </AnimatedSection>
